...
import (
    ...
    "golang_learning/webcrawler/module"
    "golang_learning/webcrawler/module/local/analyzer"
    "golang_learning/webcrawler/module/local/downloader"
    "golang_learning/webcrawler/module/local/pipeline"
)
